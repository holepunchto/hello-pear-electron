...
Add or remove entitlements here if your app requires additional capabilities (e.g. camera, microphone, location). If your app loads native addons that dynamically link shared libraries built by a different developer (e.g. Homebrew-provided libraries), you will also need `cs.disable-library-validation`.
